...
def create(request):
    if request.method == 'POST':
        ...
        try:
            ...
            messages.warning(request, 'Error when adding a movie {}'.format(e))
    return redirect('/')
...
def edit(request, movie_id):
    if request.method == 'POST':
        ...
        try:
            ...
            message.warning(request, 'Got an error when trying to update a movie:{}'.format(e))
    return redirect('/')
...
def delete(request, movie_id):
    try:
        ...
        messages.warning(request, 'got this error when trying to delete a movie: {}'.format(e))
    return redirect('/')
